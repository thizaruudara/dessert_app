...
class _StudentHomeScreenState extends State<StudentHomeScreen> {
  ...
  Widget _buildSkeletonTile(bool isDark) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isDark ? const Color(0xFF1E293B).withOpacity(0.6) : Colors.white.withOpacity(0.85),
      ...
      body: AmbientMeshBackground(
        child: RefreshIndicator(
          ...
          child: CustomScrollView(
            ...
            slivers: [
              // ── Luminous Liquid Glass Hero Header ────────────────────────
              SliverToBoxAdapter(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                gradient: const LinearGradient(
                                  colors: [Color(0xFF227AFF), Color(0xFF38BDF8)],
                                ),
                                boxShadow: [
                                  BoxShadow(
                                    color: const Color(0xFF227AFF).withOpacity(0.35),
                                    blurRadius: 10,
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    const Icon(Icons.verified_rounded, color: Color(0xFF227AFF), size: 18),
                                  ],
                                ),
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: isDark
                                        ...
                                        : const Color(0xFF227AFF).withOpacity(0.08),
                                    borderRadius: BorderRadius.circular(12),
                                    border: Border.all(
                                      color: isDark
                                          ? Colors.white.withOpacity(0.2)
                                          : const Color(0xFF227AFF).withOpacity(0.2),
                                    ),
                                  ),
                                  child: Text(
                                    '🎯 $examYear Target',
                          ...
                          LiquidGlassPill(
                            ...
                            tintColor: isDark ? const Color(0xFF1E293B) : Colors.white,
                      ...
                      // ── Gamified XP / Level Card (Liquid Glass) ────────────────────────
                      LiquidGlassCard(
                              ...
                              children: [
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        gradient: LinearGradient(
                                          colors: isDark
                                              ? [const Color(0xFFF59E0B).withOpacity(0.3), const Color(0xFFD97706).withOpacity(0.3)]
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                        color: const Color(0xFF227AFF).withOpacity(0.3),
                                        blurRadius: 8,
                                        offset: const Offset(0, 2),
                                      ),
                                    ],
                                  ...
                                  LayoutBuilder(
                                    builder: (context, constraints) {
                                      return Container(
                                        ...
                                        decoration: BoxDecoration(
                                          gradient: const LinearGradient(
                                            colors: [Color(0xFF227AFF), Color(0xFF38BDF8), Color(0xFF818CF8)],
                                          ),
                                          borderRadius: BorderRadius.circular(8),
                                          boxShadow: [
                                            BoxShadow(
                      ...
                      // ── Live A/L Exam Countdown Widget (Liquid Glass) ──────────────────
  ...
  Widget _buildSprintSpotlightCard({
    ...
    return LiquidGlassCard(
      ...
      surfaceOpacity: isDark ? 0.60 : 0.88,
      blur: 18,
      glowColor: hasAttempted ? const Color(0xFF10B981) : const Color(0xFFF59E0B),
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: isDark
                        ? [const Color(0xFFF59E0B).withOpacity(0.25), const Color(0xFFD97706).withOpacity(0.25)]
                        : [const Color(0xFFFEF3C7), const Color(0xFFFDE68A)],
                  ),
                  borderRadius: BorderRadius.circular(20),
                  border: Border.all(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: isDark ? Colors.white.withOpacity(0.12) : const Color(0xFFEFF5FF),
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(color: isDark ? Colors.transparent : const Color(0xFFDCE7FD)),
                ),
                child: Text(
                  targetDate,
                  style: TextStyle(
                    color: isDark ? Colors.white70 : const Color(0xFF227AFF),
                    fontSize: 11,
                    fontWeight: FontWeight.w700,
                  ),
                ),
      ...
      return StreamBuilder<List<UpcomingPaper>>(
        ...
        builder: (context, snapshot) {
          ...
          return LiquidGlassCard(
            ...
            borderColor: const Color(0xFF6366F1).withOpacity(isDark ? 0.4 : 0.25),
            onTap: () {
              HapticFeedbackService.light();
                ...
                Row(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: const Color(0xFF6366F1).withOpacity(isDark ? 0.25 : 0.12),
                        borderRadius: BorderRadius.circular(8),
                      ),
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                    ...
                    Container(
                      padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                      decoration: BoxDecoration(
                        color: const Color(0xFF10B981).withOpacity(isDark ? 0.15 : 0.10),
                        borderRadius: BorderRadius.circular(8),
                      ),
                      child: Text(
                        paper.subject,
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: LiquidGlassCard(
        ...
        borderRadius: BorderRadius.circular(20),
        blur: 16,
        surfaceOpacity: isDark ? 0.60 : 0.85,
        glowColor: color,
        child: Column(
          children: [
            Container(
